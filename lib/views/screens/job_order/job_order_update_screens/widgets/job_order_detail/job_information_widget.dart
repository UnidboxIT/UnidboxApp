...
class JobOrderInfoWidget extends StatelessWidget {
  const JobOrderInfoWidget({super.key});
          ...
          Container(
            ...
            child: Transform.translate(
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    //Handyman and Delivery
                    Row(
                      children: [
                        handymanAndDeliveryWidget(
                          Icons.handyman,
                          "Yan chan",
                        ),
                        const Spacer(),
  ...
  Widget handymanAndDeliveryWidget(IconData iconData, String name) {
    return Row(
      children: [
        Icon(
          iconData,
        ...
        textWidget(name, size: 13, fontWeight: FontWeight.w500),
      ],
    );
  }
