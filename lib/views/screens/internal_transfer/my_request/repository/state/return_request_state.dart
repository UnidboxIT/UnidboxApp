...
class ReturnRequestState with _$ReturnRequestState {
  const factory ReturnRequestState.incrementQty(String index, int qty) =
      IncrementReturnRequestQty;
  const factory ReturnRequestState.decrementQty(String index, int qty) =
      DecrementReturnRequestQty;
  const factory ReturnRequestState.addReturnRequestQtyTextFieldValue(
      String index, int qty) = AddReturnRequestQtyTextFieldValue;
