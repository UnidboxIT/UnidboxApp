...
class PackedProductHistoryScreen extends ConsumerStatefulWidget {
  final List<Map<String, dynamic>> requestedHistoryList;
  const PackedProductHistoryScreen(
      {super.key, required this.requestedHistoryList});

  @override
  ConsumerState<PackedProductHistoryScreen> createState() =>
      _AcceptedProductHistoryScreenState();
}

class _AcceptedProductHistoryScreenState
    extends ConsumerState<PackedProductHistoryScreen> {
