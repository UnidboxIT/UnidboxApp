...
import 'package:unidbox_app/views/screens/notification_service/noti.dart';
...
void backgroundNotificationListener(Map<String, dynamic> data) {
  ...
  superPrint('Received notification: $data');
  ...
  NotificationController.displayNotificationRationale(noti);
}
